...
/**
 * The Fraction class implements non-negative fractions, i.e., rational numbers. <br>
 * Based in the following example: <a href="http://www.cs.berkeley.edu/~jrs/61bf98/labs/lab2/Fraction.java">http://www.cs.berkeley.edu/~jrs/61bf98/labs/lab2/Fraction.java</a>
 */
public class FractionV1 {
	 ...
	 */
	public FractionV1 add(FractionV1 f2) {
		FractionV1 r = new FractionV1((numerator * f2.denominator)
	...
	public static void main(String[] argv) {
		...
		FractionV1 f0 = new FractionV1();
		FractionV1 f1 = new FractionV1(3);
		FractionV1 f2 = new FractionV1(12, 20);
